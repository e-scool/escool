...
# Create AdminUser
AdminUser.create!(:email => "admin@e-scool.com", :password => "cool2013es", :password_confirmation => "cool2013es")
...
# Create Teachers
for i in 1..20
	classrooms = school.classrooms.sample(rand(1..7))
	school.teachers.create!(:name => "Profe #{i}", :username => "profe#{i}", :email => "profe#{i}@profes.com", :password => "cool2013es", :password_confirmation => "cool2013es", :classrooms => classrooms)
end

puts '=> Creating Parents'
# Create Parents
for i in 1..100
	school.parents.create!(:name =>	"Pares #{i}", :username => "pares#{i}", :email => "pares#{i}@pares.com", :password => "cool2013es", :password_confirmation => "cool2013es")
end
